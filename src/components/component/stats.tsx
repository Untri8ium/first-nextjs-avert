...
export function Stats(props: {}) {
  ...
  //     ]: [
  //       { categories: { rows: any[] } },
  //       { votingoptions: { rows: any[] } },
  //       { votes: { rows: any[] } },
  //       { extraquestions: { rows: any[] } },
  //       { extraoptions: { rows: any[] } },
  //       { votesextra: { rows: any[] } },
  //       { vgi: { rows: any[] } }
  //     ] = await Promise.all([
  ...
  //     console.log(transformPlainObjectToVotes(votesResponse.votes.rows));

  //     preliminaryFetchedStuff = {
  //       err: [],
  //       categories: transformPlainObjectToCategories(
  ...
  //     };
  //   } catch (error) {
  //     preliminaryFetchedStuff.err = [error];
  //   }

  //   console.log(
  //     [...preliminaryFetchedStuff.votes],
  //     preliminaryFetchedStuff.votes
  //   );
  //   setFetchedStuff({
  //     err: [...preliminaryFetchedStuff.err],
  //     categories: [...preliminaryFetchedStuff.categories],
  //     options: [...preliminaryFetchedStuff.options],
  //     votes: [...preliminaryFetchedStuff.votes],
  //     extraQuestions: [...preliminaryFetchedStuff.extraQuestions],
  //     extraOptions: [...preliminaryFetchedStuff.extraOptions],
  //     votesExtra: [...preliminaryFetchedStuff.votesExtra],
  //     vgi: preliminaryFetchedStuff.vgi,
  //     time: new Date(0),
  //   });
  // };
  ...
  //     .then((fetched) => {
  //       preliminaryFetchedStuff.categories = transformPlainObjectToCategories(
  //         fetched.categories.rows
  //       );
  //     }) // Access the 'categories' property from the response
  //     .catch((error) => {
  //       preliminaryFetchedStuff.err = [...preliminaryFetchedStuff.err, error];
  //     });

  //   fetch("/api/getvotingoptions")
  //     .then((response) => response.json())
  //     .then((fetched) => {
  //       preliminaryFetchedStuff.options = transformPlainObjectToOptions(
  //         fetched.votingoptions.rows
  //       );
  //     }) // Access the 'categories' property from the response
  //     .catch((error) => {
  //       preliminaryFetchedStuff.err = [...preliminaryFetchedStuff.err, error];
  ...
  //     .then((response) => response.json())
  //     .then((fetched) => {
  //       // console.log(fetched.votes.rows);

  //       preliminaryFetchedStuff.votes = transformPlainObjectToVotes(
  //         fetched.votes.rows
  //       );
  //     }) // Access the 'categories' property from the response
  //     .catch((error) => {
  ...
  //   fetch("/api/getextraquestions")
  //     .then((response) => response.json())
  //     .then((fetched) => {
  //       preliminaryFetchedStuff.extraQuestions =
  //         transformPlainObjectToExtraQuestions(fetched.extraquestions.rows);
  //     }) // Access the 'categories' property from the response
  //     .catch((error) => {
  //       preliminaryFetchedStuff.err = [...preliminaryFetchedStuff.err, error];
  //     });

  //   fetch("/api/getextraoptions")
  //     .then((response) => response.json())
  //     .then((fetched) => {
  //       preliminaryFetchedStuff.extraOptions =
  //         transformPlainObjectToExtraOptions(fetched.extraoptions.rows);
  //     }) // Access the 'categories' property from the response
  //     .catch((error) => {
  //       preliminaryFetchedStuff.err = [...preliminaryFetchedStuff.err, error];
  //     });

  //   fetch("/api/getvotesextra")
  //     .then((response) => response.json())
  //     .then((fetched) => {
  //       console.log(fetched.votesextra.rows);

  //       preliminaryFetchedStuff.votesExtra = transformPlainObjectToVotesExtra(
  //         fetched.votesextra.rows
  //       );
  //     }) // Access the 'categories' property from the response
  //     .catch((error) => {
  //       preliminaryFetchedStuff.err = [...preliminaryFetchedStuff.err, error];
  ...
  //   console.log(preliminaryFetchedStuff);
  //   setFetchedStuff(preliminaryFetchedStuff);
  // };
