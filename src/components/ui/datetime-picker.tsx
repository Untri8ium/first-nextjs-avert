  ...
  return (
    <div
      ...
      className={cn(
        ...
        "flex items-center rounded-md border ring-offset-background bg-[#FFFFFF] dark:bg-[#000000] focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2"
      )}
    >
